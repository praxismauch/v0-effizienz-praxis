...
export const getInitialSections = (): CanvasSection[] => [
  {
    id: "key-partners", title: "Schlüsselpartner", titleEn: "Key Partners",
    description: "Wer sind unsere wichtigsten Partner und Lieferanten?",
    iconName: "Handshake", color: "bg-blue-50 border-blue-200",
    items: [item("kp-1", "Technologie-Partner (Cloud-Infrastruktur)", "high"), item("kp-2", "KI/ML-Dienstleister", "high"), item("kp-3", "Branchenverbände (KV, Ärztekammern)")],
  },
  {
    id: "key-activities", title: "Schlüsselaktivitäten", titleEn: "Key Activities",
  ...
  },
  {
    ...
    items: [item("vp-1", "Struktur. Erfolg. Leichtigkeit.", "high"), item("vp-2", "2+ Stunden Zeitersparnis täglich", "high"), item("vp-3", "KI-gestützte Praxisoptimierung", "high"), item("vp-4", "Alles-in-einem Praxismanagement")],
  },
  {
    ...
    items: [item("cr-1", "Persönlicher Support (Premium)", "high"), item("cr-2", "Self-Service Knowledge Base"), item("cr-3", "Community & Erfahrungsaustausch", "low", "planned")],
  },
  {
  ...
  {
    id: "channels", title: "Kanäle", titleEn: "Channels",
  ...
  {
    id: "key-resources", title: "Schlüsselressourcen", titleEn: "Key Resources",
