...
export default function AnalyticsError({ error, reset }: ErrorPageProps) {
  useEffect(() => {
    Logger.error("ui", "Analytics page error", error, { digest: error.digest })
  }, [error])
    ...
    <div className="flex min-h-[60vh] items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle>Analyse-Fehler</CardTitle>
          <CardDescription>
            Die Analysen konnten nicht geladen werden. Bitte versuchen Sie es erneut.
          </CardDescription>
        </CardHeader>
