...
export default function CalendarError({ error, reset }: ErrorPageProps) {
  useEffect(() => {
    Logger.error("ui", "Calendar page error", error, { digest: error.digest })
  }, [error])
    ...
    <div className="flex min-h-[60vh] items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle>Kalender-Fehler</CardTitle>
          <CardDescription>
            Der Kalender konnte nicht geladen werden. Bitte versuchen Sie es erneut.
          </CardDescription>
        </CardHeader>
