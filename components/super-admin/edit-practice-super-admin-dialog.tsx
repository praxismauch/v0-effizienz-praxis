...
interface EditPracticeSuperAdminDialogProps {
  open: boolean
...
export function EditPracticeSuperAdminDialog({
  open,
  onOpenChange,
  practice,
  onSuccess,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Erfolg",
        description: `Praxis "${formData.name}" wurde aktualisiert.`,
      })
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Aktualisieren Sie die Informationen der Praxis. Felder mit * sind Pflichtfelder.
          </DialogDescription>
        </DialogHeader>
