...
export async function PUT(
  ...
  try {
    ...
    const updateData = {
      ...
      overall_rating: restBody.overall_rating != null ? Math.round(restBody.overall_rating) : null,
      performance_rating: restBody.performance_rating != null ? Math.round(restBody.performance_rating) : null,
      potential_rating: restBody.potential_rating != null ? Math.round(restBody.potential_rating) : null,
