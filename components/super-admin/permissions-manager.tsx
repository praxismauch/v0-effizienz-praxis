...
const PERMISSION_LABELS: Record<string, string> = {
  ...
  practice_journals: "Praxis-Journal",
  documents: "Dokumente",
  knowledge: "Wissensdatenbank",
  protocols: "Protokolle",
  strategy_journey: "Strategiepfad",
  leadership: "Leadership",
  wellbeing: "Mitarbeiter-Wellbeing",
  qualitaetszirkel: "Qualitätszirkel",
  leitbild: "Leitbild",
  roi_analysis: "Lohnt-es-sich-Analyse",
  igel_analysis: "Selbstzahler-Analyse",
